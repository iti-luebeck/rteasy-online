use rt_easy::{memory_file::MemoryFile, rtvhdl::Ident};
use std::collections::HashMap;
use wasm_bindgen::prelude::*;

#[wasm_bindgen]
pub struct Vhdl(pub(crate) rt_easy::rtvhdl::Vhdl);
...
impl Vhdl {
    ...
    pub fn render(&self, module_name: String, memories_arg: Vec<JsValue>) -> Result<String> {
        ...
        self.0.render(&module_name, memories).map_err(|e| JsValue::from_str(&e.to_string()))
    }
}
